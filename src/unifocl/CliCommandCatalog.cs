internal static class CliCommandCatalog
{
    public static List<CommandSpec> CreateRootCommands()
    {
        ...
        [
            ...
            new("/project clone <source-path> <dest-path> [--no-library]", "Clone a Unity project to an isolated path for parallel agent use (PrivilegedExec — requires approval)", "/project", "setup"),
    ...
    public static List<CommandSpec> CreateProjectCommands()
    {
        ...
        [
            ...
            // ── build ─────────────────────────────────────────────────────
            new("project clone <source-path> <dest-path> [--no-library]", "Clone a Unity project to an isolated path for parallel agent use (PrivilegedExec — requires approval)", "project clone", "build"),
