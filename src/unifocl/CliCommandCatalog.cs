internal static class CliCommandCatalog
{
    public static List<CommandSpec> CreateRootCommands()
    {
        ...
        [
            ...
            new("/agent install <codex|claude> [--workspace <path>] [--server-name <name>] [--config-root <path>] [--dry-run]", "Install/update agent MCP integration for Codex or Claude", "/agent install"),
    ...
    public static List<CommandSpec> CreateProjectCommands()
    {
        ...
        [
            ...
            new("test list", "List all tests (EditMode) using Unity -listTests", "test list"),
            new("test run editmode [--timeout <seconds>]", "Run EditMode tests, capture NUnit XML results", "test run editmode"),
            new("test run playmode [--timeout <seconds>]", "Run PlayMode tests (may trigger player build)", "test run playmode"),
