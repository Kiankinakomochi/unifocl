...
internal sealed class ExecCommandRegistry
{
    private static readonly Dictionary<string, ExecRiskLevel> Operations = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["runtime.manifest"]    = ExecRiskLevel.SafeRead,
        ["runtime.query"]       = ExecRiskLevel.SafeRead,
        ["runtime.exec"]        = ExecRiskLevel.PrivilegedExec,
        ["runtime.job.submit"]  = ExecRiskLevel.PrivilegedExec,
        ["runtime.job.status"]  = ExecRiskLevel.SafeRead,
        ["runtime.job.cancel"]  = ExecRiskLevel.SafeWrite,
        ["runtime.job.list"]    = ExecRiskLevel.SafeRead,
        ["runtime.stream.subscribe"]   = ExecRiskLevel.SafeWrite,
        ["runtime.stream.unsubscribe"] = ExecRiskLevel.SafeWrite,
        ["runtime.watch.add"]    = ExecRiskLevel.SafeWrite,
        ["runtime.watch.remove"] = ExecRiskLevel.SafeWrite,
        ["runtime.watch.list"]   = ExecRiskLevel.SafeRead,
        ["runtime.watch.poll"]   = ExecRiskLevel.SafeRead,
        ["runtime.scenario.run"]      = ExecRiskLevel.PrivilegedExec,
        ["runtime.scenario.list"]     = ExecRiskLevel.SafeRead,
        ["runtime.scenario.validate"] = ExecRiskLevel.SafeRead,
        // tag operations
